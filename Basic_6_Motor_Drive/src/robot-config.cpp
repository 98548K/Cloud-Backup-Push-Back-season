...
motor LM = motor(PORT4, ratio18_1, true);//fart
motor LB = motor(PORT5, ratio18_1, true);
...
motor LIB = motor(PORT21, ratio18_1,false);
motor RIB = motor(PORT3, ratio18_1,true);
motor TIB = motor(PORT15, ratio18_1, true);
//motor_group B_Intake = motor_group(LIB, RIB);
